...
public class Ranged_Units : Units
{
    ...
    public int count = 0;
    public Ranged_Units(string name, float health, float team, float rspeed,  float attack, float ackrange, bool atck, string symbol, GameObject gameObject)//Declaring constructor
    {
        Name = name;
        Health = health;
        base.Team = team;
